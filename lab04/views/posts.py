...
class PostListEndpoint(Resource):
    ...
    def get(self):
        ...
        posts = Post.query.filter(Post.id.in_(ids_for_me_and_my_friends))
        ...
        if limit:
            try:
                ...
                return Response(json.dumps({'message': 'Interger required.'}, mimetype="application/json", status=400))
